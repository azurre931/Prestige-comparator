...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        'catMarkers'                 : null,
        'dataLocation'               : "{{ locations.json | shopify_asset_url | script_tag }}",
        'dataRaw'                    : null,
        'dataType'                   : 'json',
        'debug'                      : false,
        'defaultLat'                 : '46.2634782800751',
        'defaultLng'                 : '-72.59066945316926',
        'defaultLoc'                 : true,
        ...
        'loading'                    : false,
        'locationsPerPage'           : 10,
        'mapSettings'                : { zoom : 8, mapTypeId: google.maps.MapTypeId.ROADMAP, styles : [
    {
    ...
    },
    {
        ...
        'markerCluster'              : null,
        'markerImg'                  : "https://cdn.shopify.com/s/files/1/0555/9245/2252/files/floem-marker.svg?v=1664995427",
        'markerDim'                  : null,
        'maxDistance'                : false,
        'modal'                      : false,
        'nameAttribute'              : 'name',
	    ...
	    'selectedMarkerImg'          : "https://cdn.shopify.com/s/files/1/0555/9245/2252/files/floem-marker-select.svg?v=1664995430",
        ...
        // Templates
	    'infowindowTemplatePath'     : "{{ 'infowindow-description.liquid' | shopify_asset_url | script_tag }}",
        'listTemplatePath'           : "{{ 'location-list-description.liquid' | shopify_asset_url | script_tag }}",
